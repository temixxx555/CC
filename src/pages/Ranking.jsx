...
import { Upload, Trophy, Medal, Award, Star, Users, Clock, TrendingUp, Camera, Sparkles, Crown } from "lucide-react"
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl text-slate-600 max-w-3xl mx-auto font-medium leading-relaxed mb-8">
            Are you the <span className="font-bold text-indigo-600">main character</span> or just{" "}
            <span className="font-bold text-slate-400">background noise</span>? Post and find out.
          </p>
                  ...
                  >
                    <div
                      className={`relative bg-white rounded-2xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-xl ${
                        winner.rank === 1 ? "md:scale-110 ring-4 ring-yellow-200" : ""
                      }`}
                    >
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div className="space-y-6">
              ...
              >
                {previewUrl ? (
                  <div className="space-y-4">
                    ...
                    <p className="text-green-600 font-medium">Ready to submit!</p>
                    <button
                      type="button"
                      onClick={() => {
                        setSelectedFile(null);
              ...
              >
                {selectedFile ? "Submit to Competition" : "Select a photo first"}
              </button>
            </div>
            <div className="mt-8 p-4 bg-gray-50 rounded-xl">
              <h3 className="font-semibold text-gray-800 mb-2">Competition Rules:</h3>
              <ul className="text-sm text-gray-600 space-y-1">
                <li>• One submission per week per student</li>
                <li>• Photos must be appropriate for campus community</li>
                <li>• Background noise is a playful suggestion to be the best</li>
